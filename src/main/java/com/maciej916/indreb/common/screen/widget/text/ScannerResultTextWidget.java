...
public class ScannerResultTextWidget extends BaseWidget {
    ...
    public void renderButton(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
        ...
        GuiUtil.renderScaled(guiGraphics, Component.translatable("gui." + IndReb.MODID + ".scanner.replication_cost").getString(), getX() + 3, getY(), 0.65f, 0x00a200, false);
        GuiUtil.renderScaled(guiGraphics, Component.translatable("gui." + IndReb.MODID + ".scanner.matter_cost").getString() + " " + entity.getResult().getMatterCost() + " mB", getX() + 3, getY() + 6, 0.65f, 0x00a200, false);
        GuiUtil.renderScaled(guiGraphics, Component.translatable("gui." + IndReb.MODID + ".scanner.energy_cost").getString() + " " + TextComponentUtil.getFormattedStorageUnit(entity.getResult().getEnergyCost()) + " IE/t", getX() + 3, getY() + 12, 0.65f, 0x00a200, false);

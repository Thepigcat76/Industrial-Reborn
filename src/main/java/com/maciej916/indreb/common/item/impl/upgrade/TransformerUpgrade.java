...
public class TransformerUpgrade extends BaseUpgradeItem {
    ...
    public TransformerUpgrade() {
        super(UpgradeTypes.TRANSFORMER);
    }
    ...
    public void appendHoverText(ItemStack stack, Level p_41422_, List<Component> components, TooltipFlag tooltipFlag) {
        ...
        components.add(Component.translatable("transformer." + IndReb.MODID + ".max", Component.translatable(EnergyTiers.ULTRA.getLang().getTranslationKey())).withStyle(ChatFormatting.RED));

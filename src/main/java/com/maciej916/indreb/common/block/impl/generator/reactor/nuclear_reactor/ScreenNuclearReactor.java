...
public class ScreenNuclearReactor extends IndRebScreen<MenuNuclearReactor> {
    ...
    public void initElements() {
        ...
        addUsableWidget(new GuiPlayPauseButtonWidget(this, 100, 129, entity.getReactor(), entity.clickPlayPauseClient(), List.of(EnumLang.REACTOR_PLAY_PAUSE.getTranslationComponent())));

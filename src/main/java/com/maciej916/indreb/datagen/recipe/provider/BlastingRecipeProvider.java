...
public class BlastingRecipeProvider extends RecipeProvider {
    ...
    public BlastingRecipeProvider(PackOutput output) {
        super(output);
    }
    ...
    protected void buildRecipes(Consumer<FinishedRecipe> consumer) {
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_TIN), RecipeCategory.MISC, ModItems.TIN_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_ORE_TIN), RecipeCategory.MISC, ModItems.TIN_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_TIN), RecipeCategory.MISC, ModItems.TIN_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_LEAD), RecipeCategory.MISC, ModItems.LEAD_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_ORE_LEAD), RecipeCategory.MISC, ModItems.LEAD_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_LEAD), RecipeCategory.MISC, ModItems.LEAD_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_URANIUM), RecipeCategory.MISC, ModItems.URANIUM_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_ORE_URANIUM), RecipeCategory.MISC, ModItems.URANIUM_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_URANIUM), RecipeCategory.MISC, ModItems.URANIUM_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_RAW_MATERIALS_SILVER), RecipeCategory.MISC, ModItems.SILVER_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_ORE_SILVER), RecipeCategory.MISC, ModItems.SILVER_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_SILVER), RecipeCategory.MISC, ModItems.SILVER_INGOT.get(), 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_COPPER), RecipeCategory.MISC, Items.COPPER_INGOT, 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_IRON), RecipeCategory.MISC, Items.IRON_INGOT, 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItemTags.FORGE_DUSTS_GOLD), RecipeCategory.MISC, Items.GOLD_INGOT, 0.6f, 100)
        ...
        SimpleCookingRecipeBuilder.blasting(Ingredient.of(ModItems.REINFORCED_STONE.get()), RecipeCategory.MISC, ModItems.SMOOTH_REINFORCED_STONE.get(), 0.1f, 100)
